<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmCommandControl.aspx.cs" Inherits="DevControl.FrmCommandControl" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:ImageButton ID="btnImage" runat="server"
                ImageUrl="./images/btn_post.jpg" ToolTip="홈으로..."
